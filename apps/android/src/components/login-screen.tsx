...
export function LoginScreen() {
	...
	const title = useMemo(
		() =>
			mode === "login" ? "ورود حرفه‌ای به چکاوک" : "ثبت‌نام سریع در چکاوک",
		[mode],
	);
		...
		<SafeAreaView style={{ flex: 1, backgroundColor: theme.background }}>
			<ThemedView style={styles.screen}>
				<View style={styles.hero}>
					...
					>
						Live voice rooms, Persian-first.
					</ThemedText>
				</View>
				...
				>
					<View
						style={[styles.modeWrap, { backgroundColor: theme.primaryMuted }]}
					>
						<Pressable
							style={[
								styles.modeBtn,
						...
						>
							<ThemedText
								type="smallBold"
								style={mode === "login" ? styles.modeTextActive : undefined}
							>
								ورود
							</ThemedText>
						</Pressable>
						...
						>
							<ThemedText
								type="smallBold"
								style={mode === "signup" ? styles.modeTextActive : undefined}
							>
								ثبت‌نام
							</ThemedText>
						</Pressable>
